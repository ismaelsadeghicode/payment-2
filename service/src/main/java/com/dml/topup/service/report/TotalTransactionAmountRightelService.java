...
/**
 * @author Ismael Sadeghi, 6/2/2019 6:39 PM
 */
@Component
public class TotalTransactionAmountRightelService {

    private final LoggingRepository loggingRepository;

    @Autowired
    public TotalTransactionAmountRightelService(LoggingRepository loggingRepository) {
        this.loggingRepository = loggingRepository;
    }

    public int findTotalTransactionAmountRightel() {
