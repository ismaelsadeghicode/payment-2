...
@RestController
@RequestMapping("v1/direct-topup-mci")
public class DirectTopupMCIController {

    private final DirectTopupService service;

    @Autowired
    public DirectTopupMCIController(DirectTopupService service) {
        this.service = service;
    }

    @Async
    @PostMapping
    @Timed(value = "direct-topup-mci-topup", histogram = true, percentiles = {0.95, 0.99}, extraTags = {"version", "1.0"})
